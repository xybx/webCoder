<template>
  <el-card class="box-card">
    ...
    <div class="text item">
      <queryForm ref="queryRef" :users="true" @queryData="queryClick" @handleAdd="handleAdd" />
      <el-table ref="tableRef" :data="tableData" border v-loading="tabloading" :element-loading-text="loadingText">
          ...
          <el-table-column label="操作" >
              <template #default="{ row ,$index}">
                ...
                <el-button type="danger" @click="delClick(row.pid)" v-if="row.rule!='系统管理员'">删除</el-button>
              </template>
          </el-table-column>
      </el-table>
    ...
    <userDialog ref="userRef" @getData="getTableList" />
  </el-card>
</template>
...
<script setup lang="ts">
  ...
  import {delUsers, getUsersList} from "/@/views/generator/api/userapi.ts";
